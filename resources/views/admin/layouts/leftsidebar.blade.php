...
<div class="sidebar print:hidden">
    ...
    <div class="main-sidebar">
      ...
      >
        ...
        <div class="flex pt-4">
          <a href="index.html">
            <img
              ...
              src="/frontend/images/app-logo.svg"
              alt="logo"
            />
          </a>
        </div>
        ...
        <a
        href="/dashboard"
        class="flex h-11 w-11 items-center justify-center bg-primary/10 rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
  ...
  >
    ...
    >
      ...
      <path
        ...
        class="stroke-primary dark:stroke-accent-light"
  ...
  <div
          ...
          >
            ...
            >
              <img
                class="rounded-full"
                src="/frontend/images/avatar/avatar-12.jpg"
                alt="avatar"
              />
              <span
